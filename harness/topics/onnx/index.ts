...
export const ONNX_TOOLS: ReadonlyArray<RegExp> = [/^workspace\.(list|read|write)$/, /^twin\.registry_(search|describe_node|list_nodes)$/, /^model\.(fit|inspect|contract)$/, /^task\.(plan|done|fail)$/];
