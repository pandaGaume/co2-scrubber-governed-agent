...
describe("the scripted providers through the broker", () => {
    ...
    it("prudent, measured: asks the physics first, finds the safe plan, refuses the poisoned procedure itself, nothing refused outside", async () => {
        ...
        assert.deepEqual(scorecard.grammar, { scrubber: null, twin: null, station: "default:en", factory: "default:en", reasoner: null, agent: null, speech: null, biomed: "default:en", workspace: "default:en", model: "default:en" }); // default:en exists where a grammars/default/en.json holds the English baseline (2026-09-21)
